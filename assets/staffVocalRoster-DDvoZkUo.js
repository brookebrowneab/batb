import{g as I,a as V}from"./index-D8JtWtNr.js";import{f as b,a as h}from"./scheduling-DSZ8OVmG.js";import{e as x}from"./escapeHtml-lW1fV86Q.js";import{a as F,h as G,b as H,j as O,V as L,k as N,l as P}from"./vocalBookings-CNJrwrgw.js";import{f as j}from"./scheduling-CaqKIUZg.js";import{c as z,b as q,d as U}from"./rateLimiting-C6g2f-wn.js";import{f as Y,e as J,g as K}from"./rolePreferences-DCjwN29-.js";import{i as k}from"./rolePreferences-B9XCX_X4.js";import"./evaluations-CinD28hm.js";import"./callbacks-CEzeXmpj.js";import"./students-C4Im7lf4.js";import"./storage-BUQKYqIH.js";const Q=z(q),W=z(U);let g=[],M=[],B={},v="",$=null,S=[],A=[],m=new Set;function ft(){const l=document.createElement("div");return l.className="page",l.innerHTML=`
    <h1>Vocal Roster 🎤</h1>
  ...
  `,setTimeout(()=>E(),0),l}async function E(){const[l,c,n,d,i,t]=await Promise.all([F(),G(),H(),Y(),j(),J()]);g=l.data||[],M=c.data||[],B=n.data||{},$=d.data||null,S=[...new Set((i.data||[]).map(o=>o.audition_date))].sort(),A=t.data||[],m=new Set([...m].filter(o=>g.some(s=>s.id===o)));const e=document.getElementById("vocal-roster-mode-banner");e&&k($)?e.innerHTML=`
