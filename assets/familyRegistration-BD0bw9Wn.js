import{g as U}from"./index-CvLlIQq8.js";import{f as D,d as j,u as N,c as F}from"./students-BdMRccDH.js";import{f as H,a as z,d as G}from"./contracts-CHxjH8lw.js";import{g as M,u as O,a as V}from"./storage-da3M60H6.js";import{v as W,h as Y,r as J}from"./sanitizeHtml-D1SfNnaG.js";import{v as K,e as L}from"./registration-BJf__55_.js";import{i as Q}from"./emailValidation-DoK9MuSU.js";import{e as d}from"./escapeHtml-lW1fV86Q.js";import{f as X,b as Z,c as ee,s as te,d as ne}from"./rolePreferences-CjF-1O--.js";import{v as ae,i as se,s as q}from"./rolePreferences-B9XCX_X4.js";import{s as re}from"./notifications-ZYucFxph.js";import"./purify.es-B9ZVCkUG.js";import"./scheduling-DSZ8OVmG.js";let E=[],t=null,S=[],h=null,g=1,A=null,C=[],k=[];function oe(){const e=window.location.hash||"",n=e.indexOf("?");return n===-1?null:new URLSearchParams(e.slice(n+1)).get("studentId")||null}function P(){return C.length>0&&se(A)}function T(){const e=["Student Info","Parent/Guardian","Audition Song","Photo"];return P()&&e.push("Role Preferences"),e.push("Review & Sign"),e}async function ie(e,n=null,a=!1){const[o,i,l,v]=await Promise.all([D(e),H(),X(),Z()]);if(E=o.data||[],h=i.data,A=l.data,C=v.data||[],a?t=null:n?t=E.find(f=>f.id===n)||null:E.length>0?t=E[0]:t=null,t){const[f,_]=await Promise.all([z(t.id),P()?ee(t.id):{data:[]}]);S=f.data||[],k=_.data||[]}else S=[],k=[]}function le(){const e=T();let n='<div class="wizard-progress">';for(let a=1;a<=e.length;a++){a>1&&(n+=`<div class="wizard-progress__connector${a<=g?" wizard-progress__connector--complete":""}"></div>`);let o="wizard-progress__dot",i=String(a);a<g?(o+=" wizard-progress__dot--complete",i="✓"):a===g&&(o+=" wizard-progress__dot--active"),n+=`<div class="wizard-progress__step"><div class="${o}">${i}</div><span class="${a===g?"wizard-progress__label wizard-progress__label--active":"wizard-progress__label"}">${e[a-1]}</span></div>`}return n+="</div>",n}function de(){let e="";if(E.length>1){const n=E.map(a=>{const o=t&&a.id===t.id?"selected":"";return`<option value="${a.id}" ${o}>${d(a.first_name||"Unnamed")} ${d(a.last_name||"Student")}</option>`}).join("");e+=`<div class="student-selector"><label for="student-select"><strong>Student:</strong></label><select id="student-select">${n}</select></div>`}return E.length>=1&&(e+=`
