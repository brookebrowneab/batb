import{g as p}from"./index-BKdYyjDr.js";import{f as g,a as f,d as v}from"./contracts-B4OLYASI.js";import{f as y}from"./students-DT9fPqEl.js";import{r as b,h,v as S}from"./sanitizeHtml-D1SfNnaG.js";import{e as d}from"./escapeHtml-lW1fV86Q.js";import"./purify.es-B9ZVCkUG.js";async function x(t){const[e,n]=await Promise.all([g(),y(t)]),a=e.data,r=n.data||[],c=await Promise.all(r.map(async s=>{const{data:i}=await f(s.id);return{...s,acceptances:i||[]}}));return{activeContract:a,students:c}}function $(t,e){if(h(t.acceptances,e.id)){const a=t.acceptances.find(r=>r.contract_id===e.id);return`
