import{g as U}from"./index-Bv59R015.js";import{f as D,d as j,u as N,c as H}from"./students-BNVNcBea.js";import{f as F,a as z,d as G}from"./contracts-B0gzOmPx.js";import{g as M,u as O,a as W}from"./storage-Bi9KOKJk.js";import{v as Y,h as J,r as V}from"./sanitizeHtml-D1SfNnaG.js";import{v as K,e as L}from"./registration-BJf__55_.js";import{i as Q}from"./emailValidation-DoK9MuSU.js";import{e as d}from"./escapeHtml-lW1fV86Q.js";import{f as X,b as Z,c as ee,s as te}from"./rolePreferences-jRPX3H86.js";import{v as ne,i as ae,s as q}from"./rolePreferences-B9XCX_X4.js";import{s as se}from"./notifications-esfA8WLD.js";import"./purify.es-B9ZVCkUG.js";import"./scheduling-DSZ8OVmG.js";let E=[],t=null,S=[],h=null,u=1,A=null,$=[],C=[];function re(){const e=window.location.hash||"",n=e.indexOf("?");return n===-1?null:new URLSearchParams(e.slice(n+1)).get("studentId")||null}function P(){return $.length>0&&ae(A)}function T(){const e=["Student Info","Parent/Guardian","Audition Song","Photo"];return P()&&e.push("Role Preferences"),e.push("Review & Sign"),e}async function oe(e,n=null,a=!1){const[o,i,l,f]=await Promise.all([D(e),F(),X(),Z()]);if(E=o.data||[],h=i.data,A=l.data,$=f.data||[],a?t=null:n?t=E.find(g=>g.id===n)||null:E.length>0?t=E[0]:t=null,t){const[g,_]=await Promise.all([z(t.id),P()?ee(t.id):{data:[]}]);S=g.data||[],C=_.data||[]}else S=[],C=[]}function ie(){const e=T();let n='<div class="wizard-progress">';for(let a=1;a<=e.length;a++){a>1&&(n+=`<div class="wizard-progress__connector${a<=u?" wizard-progress__connector--complete":""}"></div>`);let o="wizard-progress__dot",i=String(a);a<u?(o+=" wizard-progress__dot--complete",i="✓"):a===u&&(o+=" wizard-progress__dot--active"),n+=`<div class="wizard-progress__step"><div class="${o}">${i}</div><span class="${a===u?"wizard-progress__label wizard-progress__label--active":"wizard-progress__label"}">${e[a-1]}</span></div>`}return n+="</div>",n}function le(){let e="";if(E.length>1){const n=E.map(a=>{const o=t&&a.id===t.id?"selected":"";return`<option value="${a.id}" ${o}>${d(a.first_name||"Unnamed")} ${d(a.last_name||"Student")}</option>`}).join("");e+=`<div class="student-selector"><label for="student-select"><strong>Student:</strong></label><select id="student-select">${n}</select></div>`}return E.length>=1&&(e+=`
  ...
  `}async function I(e,n={}){const{forceSendScheduleEmail:a=!1}=n;if(!t)return;const o=L(t,S,(h==null?void 0:h.id)||null),i=t.registration_complete===!0;o.complete!==t.registration_complete&&(await N(t.id,{registration_complete:o.complete},e),t.registration_complete=o.complete);let l=null;if(o.complete&&(a||!i)){const{error:g}=await se(t.id);g&&(console.error("Registration schedule email failed:",g.message||g),l=g)}return{complete:o.complete,emailError:l}}function be(e,n){const a=document.getElementById("student-select");a&&a.addEventListener("change",()=>{u=1,n(a.value)});const o=document.getElementById("add-student-btn");o&&o.addEventListener("click",()=>{t=null,S=[],u=1,n(null,!0)});const i=document.getElementById("clear-registration-btn");i&&i.addEventListener("click",async()=>{if(!(t!=null&&t.id))return;const l=`${t.first_name||""} ${t.last_name||""}`.trim()||"this student";if(!window.confirm(`Clear registration for ${l}? This deletes the student record and all related registration data.`))return;i.disabled=!0;const{error:g}=await j(t.id);if(g){i.disabled=!1,window.alert("Failed to clear registration: "+g.message);return}t=E.filter(c=>c.id!==t.id)[0]||null,S=[],C=[],u=1,n((t==null?void 0:t.id)||null,!t)})}function ye(e){const n=document.getElementById("wizard-back-btn");n&&n.addEventListener("click",()=>{u>1&&(u--,e(t==null?void 0:t.id))}),document.querySelectorAll(".edit-step-btn").forEach(o=>{o.addEventListener("click",()=>{u=parseInt(o.dataset.step,10),e(t==null?void 0:t.id)})});const a=document.querySelector(".skip-step-btn");a&&a.addEventListener("click",()=>{u++,e(t==null?void 0:t.id)})}async function he(e){const n=document.getElementById("photo-preview");if(!n||!e)return;const{url:a}=await W(e);a&&(n.innerHTML=`<img src="${a}" alt="Student photo" class="photo-preview" />`)}function _e(){const e=Array.from(document.querySelectorAll(".role-rank-select"));if(e.length===0)return;function n(){const a=new Set;e.forEach(i=>{const l=i.value;if(l){if(a.has(l)){i.value="";return}a.add(l)}});const o=new Set(e.map(i=>i.value).filter(Boolean));e.forEach(i=>{Array.from(i.options).forEach(l=>{if(!l.value){l.disabled=!1;return}l.disabled=l.value!==i.value&&o.has(l.value)})})}e.forEach(a=>{a.addEventListener("change",()=>{const o=document.getElementById("role-prefs-msg");o&&(o.textContent=""),n()})}),n()}function xe(e,n){const a=document.getElementById("student-form");a&&a.addEventListener("submit",async c=>{var v;c.preventDefault();const r=document.getElementById("student-form-msg"),s=a.querySelector("button"),p={firstName:document.getElementById("reg-first-name").value.trim(),lastName:document.getElementById("reg-last-name").value.trim(),grade:document.getElementById("reg-grade").value.trim()},m=((v=document.getElementById("reg-student-email"))==null?void 0:v.value.trim())||"";if(!p.firstName||!p.lastName||!p.grade){r.textContent="First name, last name, and grade are required.",r.className="form-message error";return}if(s.disabled=!0,s.textContent="Saving…",t){const{data:b,error:y}=await N(t.id,{first_name:p.firstName,last_name:p.lastName,grade:p.grade,student_email:m||null},e);if(y){r.textContent="Error: "+y.message,r.className="form-message error",s.disabled=!1,s.textContent="Save & Continue";return}t={...t,...b},await I(e),u=2,n(t.id)}else{const{data:b,error:y}=await H({familyAccountId:e,firstName:p.firstName,lastName:p.lastName,grade:p.grade,studentEmail:m||void 0,createdByUserId:e});if(y){r.textContent="Error: "+y.message,r.className="form-message error",s.disabled=!1,s.textContent="Save & Continue";return}t=b,await I(e),u=2,n(t.id)}});const o=document.getElementById("parent-form");if(o){o.addEventListener("submit",async r=>{var x,w,k,B,R;r.preventDefault();const s=document.getElementById("parent-form-msg"),p=o.querySelector("button"),m={parent_first_name:document.getElementById("reg-parent-first").value.trim(),parent_last_name:document.getElementById("reg-parent-last").value.trim(),parent_email:document.getElementById("reg-parent-email").value.trim(),parent_phone:document.getElementById("reg-parent-phone").value.trim()};if(((x=document.getElementById("reg-show-parent2"))==null?void 0:x.checked)?(m.parent2_first_name=((w=document.getElementById("reg-parent2-first"))==null?void 0:w.value.trim())||null,m.parent2_last_name=((k=document.getElementById("reg-parent2-last"))==null?void 0:k.value.trim())||null,m.parent2_email=((B=document.getElementById("reg-parent2-email"))==null?void 0:B.value.trim())||null,m.parent2_phone=((R=document.getElementById("reg-parent2-phone"))==null?void 0:R.value.trim())||null):(m.parent2_first_name=null,m.parent2_last_name=null,m.parent2_email=null,m.parent2_phone=null),!m.parent_first_name||!m.parent_last_name||!m.parent_email||!m.parent_phone){s.textContent="Parent 1 fields are required.",s.className="form-message error";return}if(Q(m.parent_email)){s.textContent="Student email addresses cannot be used. Please use a parent or guardian email.",s.className="form-message error";return}p.disabled=!0,p.textContent="Saving…";const{data:b,error:y}=await N(t.id,m,e);if(y){s.textContent="Error: "+y.message,s.className="form-message error",p.disabled=!1,p.textContent="Save & Continue";return}t={...t,...b},await I(e),u=3,n(t.id)});const c=document.getElementById("reg-show-parent2");c&&c.addEventListener("change",()=>{const r=document.getElementById("parent2-fields");r&&(r.style.display=c.checked?"block":"none")})}const i=document.getElementById("song-form");i&&(i.querySelectorAll('input[name="sings-own"]').forEach(c=>{c.addEventListener("change",()=>{const r=document.getElementById("song-name-field");r&&(r.style.display=c.value==="yes"&&c.checked?"block":"none")})}),i.addEventListener("submit",async c=>{var k,B;c.preventDefault();const r=document.getElementById("song-form-msg"),s=i.querySelector('button[type="submit"]'),p=((k=i.querySelector('input[name="sings-own"]:checked'))==null?void 0:k.value)==="yes",m=((B=document.getElementById("reg-song-name"))==null?void 0:B.value.trim())||"",{valid:v,error:b}=K(p,m);if(!v){r.textContent=b,r.className="form-message error";return}s.disabled=!0,s.textContent="Saving…";const y={sings_own_disney_song:p,song_name:p?m:null},{data:x,error:w}=await N(t.id,y,e);if(w){r.textContent="Error: "+w.message,r.className="form-message error",s.disabled=!1,s.textContent="Save & Continue";return}t={...t,...x},u=4,n(t.id)}));const l=document.getElementById("photo-form");l&&(l.addEventListener("submit",async c=>{c.preventDefault();const r=document.getElementById("photo-form-msg"),s=l.querySelector("button"),m=document.getElementById("reg-photo").files[0];if(!m){r.textContent="Please select a photo.",r.className="form-message error";return}s.disabled=!0,s.textContent="Uploading…",r.textContent="";try{const v=M(e,m.name),{error:b}=await O(v,m);if(b){r.textContent="Upload failed: "+(b.message||JSON.stringify(b)),r.className="form-message error",s.disabled=!1,s.textContent="Upload & Continue";return}const{data:y,error:x}=await N(t.id,{photo_storage_path:v},e);if(x){r.textContent="Error saving photo reference: "+(x.message||JSON.stringify(x)),r.className="form-message error",s.disabled=!1,s.textContent="Upload & Continue";return}t={...t,...y},await I(e),u++,n(t.id)}catch(v){r.textContent="Unexpected error: "+(v.message||String(v)),r.className="form-message error",s.disabled=!1,s.textContent="Upload & Continue"}}),t!=null&&t.photo_storage_path&&he(t.photo_storage_path)),_e();const f=document.getElementById("save-role-prefs-btn");f&&f.addEventListener("click",async()=>{const c=document.getElementById("role-prefs-msg"),r=document.querySelectorAll(".role-rank-select"),s=[];r.forEach(v=>{const b=parseInt(v.value,10);b&&s.push({roleId:v.dataset.roleId,rank:b})});const p=ne(s,$);if(!p.valid){c&&(c.textContent=p.errors[0]||"Each rank can only be used once.",c.className="form-message error");return}f.disabled=!0,f.textContent="Saving…",c&&(c.textContent="");const{error:m}=await te(t.id,s,e);if(m){c&&(c.textContent="Error: "+m.message,c.className="form-message error"),f.disabled=!1,f.textContent="Save & Continue";return}u++,n(t.id)});const g=document.getElementById("skip-role-prefs-btn");g&&g.addEventListener("click",()=>{u++,n(t.id)});const _=document.getElementById("contract-form");_&&_.addEventListener("submit",async c=>{c.preventDefault();const r=document.getElementById("contract-form-msg"),s=_.querySelector("button"),p=document.getElementById("reg-student-sig").value.trim(),m=document.getElementById("reg-parent-sig").value.trim(),{valid:v,errors:b}=Y(p,m);if(!v){r.textContent=b.join(" "),r.className="form-message error";return}s.disabled=!0,s.textContent="Signing…";const{error:y}=await G({studentId:t.id,contractId:h.id,studentTypedSignature:p,parentTypedSignature:m,signedByUserId:e});if(y){r.textContent="Error: "+y.message,r.className="form-message error",s.disabled=!1,s.textContent="Sign & Complete Registration";return}const{data:x}=await z(t.id);S=x||[];const{emailError:w}=await I(e,{forceSendScheduleEmail:!0});if(w){r.textContent=`Registration completed, but schedule email failed to send. Please contact staff. (${w.message||"Email send error"})`,r.className="form-message error",s.disabled=!1,s.textContent="Signed (Email Retry Needed)";return}n(t.id)})}function qe(){const e=document.createElement("div");e.className="page",e.innerHTML=`
